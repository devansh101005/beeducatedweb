...
export default {
  ...
  theme: {
    extend: {
      // ============================================
      // COLOR SYSTEM
      // Premium EdTech palette inspired by PhysicsWallah's trust
      // and Razorpay's fintech polish
      // ============================================
      colors: {
        // Primary: Deep Slate (trust, professionalism, academia)
        slate: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
        ...
        // Accent: Warm Amber (energy, achievement, highlights)
        amber: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
        ...
        // Brand colors (keeping legacy support)
        primary: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      boxShadow: {
        ...
        'amber-glow': '0 4px 14px 0 rgb(245 158 11 / 0.15)',
        'emerald-glow': '0 4px 14px 0 rgb(16 185 129 / 0.15)',
        'rose-glow': '0 4px 14px 0 rgb(244 63 94 / 0.15)',
        'sky-glow': '0 4px 14px 0 rgb(14 165 233 / 0.15)',
        // Elevated card shadow
        'elevated': '0 0 0 1px rgb(0 0 0 / 0.03), 0 2px 4px rgb(0 0 0 / 0.03), 0 12px 24px rgb(0 0 0 / 0.05)',
        'elevated-lg': '0 0 0 1px rgb(0 0 0 / 0.03), 0 4px 8px rgb(0 0 0 / 0.04), 0 24px 48px rgb(0 0 0 / 0.08)',
      },
      ...
      animation: {
        ...
        // Stagger children
        'stagger': 'fadeInUp 0.4s ease-out forwards',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
