      ...
      <section className="testimonials">
        <div className="container">
          <div className="section-header">
            ...
            <p>Real experiences from our learning community</p>
          </div>
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    <h4>Our Address</h4>
                    <p>
                      123 Education Hub, Knowledge Park
                      <br />
                      Academic City, State 560001
                      <br />
                      India
                    </p>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              <div className="footer-logo">
                <div className="logo-container">
                  <img src="/src/assests/logo.png" alt="Excellence Coaching Logo" className="logo-image" />
                  <div className="logo-content">
                    <span className="logo-text">Excellence Coaching</span>
                    <span className="logo-tagline">Building Bright Minds</span>
                  </div>
                </div>
          ...
          <div className="footer-bottom">
            <p>&copy; 2024 Excellence Coaching Institute. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
